...
### About the Developer
I am a Supply Chain Analyst with over 4 years of experience in inventory planning, logistics coordination, and procurement operations. My work focuses on leveraging SQL, Python, and the modern data stack to improve reporting accuracy and operational visibility. This project serves as a prototype for implementing robust analytics engineering workflows to solve complex supply chain and transactional data challenges.